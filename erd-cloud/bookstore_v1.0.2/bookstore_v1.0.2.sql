...
CREATE TABLE `point_save_rule` (
	...
	`point_save_rule_generate_date`	datetime	NULL,
...
CREATE TABLE `discount` (
	...
	`book_discount_date`	VARCHAR(255)	NULL
);
...
ALTER TABLE `point_history` ADD CONSTRAINT `FK_point_save_rule_TO_point_history_1` FOREIGN KEY (
	`point_save_rule_id`
)
REFERENCES `point_save_rule` (
	`point_save_rule_id`
);
...
ALTER TABLE `order` ADD CONSTRAINT `FK_customer_TO_order_1` FOREIGN KEY (
	`customer_id`
)
REFERENCES `customer` (
	`customer_id`
...
ALTER TABLE `order` ADD CONSTRAINT `FK_member_coupon_TO_order_1` FOREIGN KEY (
	`member_coupon_id`
)
...
ALTER TABLE `order_detail` ADD CONSTRAINT `FK_member_coupon_TO_order_detail_1` FOREIGN KEY (
	`member_coupon_id`
)
REFERENCES `member_coupon` (
	`member_coupon_id`
...
ALTER TABLE `refund` ADD CONSTRAINT `FK_refund_reason_TO_refund_1` FOREIGN KEY (
	`refund_reason_id`
)
REFERENCES `refund_reason` (
	`refund_reason_id`
);

ALTER TABLE `refund` ADD CONSTRAINT `FK_order_detail_TO_refund_1` FOREIGN KEY (
	`order_id`
)
REFERENCES `order_detail` (
	`order_id`
...
ALTER TABLE `refund` ADD CONSTRAINT `FK_order_detail_TO_refund_2` FOREIGN KEY (
	`book_id`
)
REFERENCES `order_detail` (
	`book_id`
...
ALTER TABLE `order_detail_packaging` ADD CONSTRAINT `FK_packaging_TO_order_detail_packaging_1` FOREIGN KEY (
	`packaging_id`
)
...
ALTER TABLE `order_detail_packaging` ADD CONSTRAINT `FK_order_detail_TO_order_detail_packaging_1` FOREIGN KEY (
	`order_id`
)
REFERENCES `order_detail` (
	`order_id`
...
ALTER TABLE `order_detail_packaging` ADD CONSTRAINT `FK_order_detail_TO_order_detail_packaging_2` FOREIGN KEY (
	`book_id`
)
REFERENCES `order_detail` (
	`book_id`
...
ALTER TABLE `coupon` ADD CONSTRAINT `FK_coupon_rule_TO_coupon_1` FOREIGN KEY (
	`coupon_rule_id`
)
REFERENCES `coupon_rule` (
	`coupon_rule_id`
);
...
ALTER TABLE `delivery` ADD CONSTRAINT `FK_delivery_rule_TO_delivery_1` FOREIGN KEY (
	`delivery_rule`
)
...
ALTER TABLE `point_order` ADD CONSTRAINT `FK_order_TO_point_order_1` FOREIGN KEY (
	`order_id`
)
REFERENCES `order` (
	`order_id`
...
ALTER TABLE `point_review` ADD CONSTRAINT `FK_review_TO_point_review_1` FOREIGN KEY (
	`order_id`
)
REFERENCES `review` (
	`order_id`
...
ALTER TABLE `point_review` ADD CONSTRAINT `FK_review_TO_point_review_2` FOREIGN KEY (
	`book_id`
)
REFERENCES `review` (
	`book_id`
...
ALTER TABLE `point_refund` ADD CONSTRAINT `FK_refund_TO_point_refund_1` FOREIGN KEY (
	`refund_id`
)
REFERENCES `refund` (
	`refund_id`
...
ALTER TABLE `discount` ADD CONSTRAINT `FK_book_TO_discount_1` FOREIGN KEY (
	`book_id`
)
REFERENCES `book` (
	`book_id`
