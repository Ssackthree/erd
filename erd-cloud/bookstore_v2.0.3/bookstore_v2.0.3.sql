...
CREATE TABLE publisher (
	...
	publisher_is_used BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE member (
	...
	payco_id_number VARCHAR(255) NULL COMMENT '페이코 ID 번호',
	PRIMARY KEY (customer_id),
    ...
    -- payco_id_number에 UNIQUE 제약 조건 추가
	CONSTRAINT UNIQUE_payco_id_number UNIQUE (payco_id_number)
);
