...
CREATE TABLE `member_coupon` (
	...
	`member_coupon_created_at`	timestamp	NOT NULL,
	`member_coupon_expired_at`	timestamp	NOT NULL,
	`member_coupon_is_used`	boolean	NOT NULL,
	`member_coupon_used_at`	timestamp	NOT NULL
);
...
CREATE TABLE `coupon` (
	...
	`coupon_create_at`	timestamp	NOT NULL,
	`coupon_expired_at`	VARCHAR(255)	NULL
);
